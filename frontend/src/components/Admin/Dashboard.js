...
const Dashboard = ({ getAllMovies }) => {
  return (
    <div className='bodyAdmin'>
      <div className="app-containerNavpr">
       ...
       <div className="account-info">
         ...
         <div className="account-info-name">Administrator</div>
     ...
     <div className="app-contentadd">
       <div className="app-contentadd-header">
         <h1 className="app-contentadd-headerText">Movies</h1>
        <Link to ="/Admin/AddMovies">
         <button className="app-contentadd-headerButton" >
         Add Movies</button></Link>

       </div>

       <div className="app-contentadd-actions">
         <input className="search-bar" placeholder="Search..." type="text" />
        <div className="app-contentadd-actions-wrapper">
       ...
       <div className="products-area-wrapper tableView">
         <div className="products-header">
           <div className="product-cell image">
             List Movies
             <button className="sort-button"    type="button"    onClick={async()=>{ await  getAllMovies() }}>
           ...
           </div>           <div className="product-cell sales">
            Salles
             <button className="sort-button">
              <svg
                 xmlns="http://www.w3.org/2000/svg"
