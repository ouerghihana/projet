...
const login = async(value)=> {
 ...
 <div>
  ...
  <div >
  <img  className="logo_container"  src ='https://img.freepik.com/vecteurs-premium/illustration-vectorielle-clap-cinema-bobine-film_34401-243.jpg' alt='myimg'/></div>
  <div className="title_container">
    <p className="title">Let's create your Account </p>
    <span className="subtitle">
     Take the first step towards movie magic. Sign up today!
    </span>
  </div>
  <br />
  ...
  <input
    ...
    id="Name_field"   value ={UserName}  onChange={(e)=>setUserName(e.target.value)}
  />
</div>
    ...
    <input
      ...
      type="text"
      className="input_field"
      id="email_field"   value ={email}  onChange={(e)=>setEmail(e.target.value)}
    />
  </div>
  <div className="input_container">
  ...
  <button title="Sign In" type="button" className="sign-in_btn"         onClick={()=>login ({UserName,email,password})}>
    <span>Sign In</span>
  </button>
